...
import { userCount ,taskCount , completedTaskCount ,pendingTaskCount ,getUserTask ,topUserTask ,addNewUserRole} from "../../controller/admin/task.controller";
const dashboard = (app : Express) => {
    ...
    //admin info 
    app.post('/api/admin/newRole' , Authentication("ADMIN") , addNewUserRole) ;
}
